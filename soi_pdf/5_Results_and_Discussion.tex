...
This can be explained by the underlying reason behind the deviations, which is not in fact primarily attributed to statistical fluctuations --- those 
...
are kept to a minimum due to averaging over time --- but
...
regarding the halting of the spread can be observed.\newline
