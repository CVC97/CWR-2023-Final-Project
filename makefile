...
animate12:
	cd soi_animations && manim -pqh --fps 12 soi_animations.py soi_main_scene && cd media/videos/soi_animation/1080p12 && ffmpeg -i soi_main_scene.mp4 -filter:v fps=60 soi_main_scene_fps60.mp4
