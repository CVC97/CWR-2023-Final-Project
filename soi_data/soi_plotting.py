...
ax[0].scatter(p1_array, avg_ratio_infected_p1_03_03_L64, color = 'blue', s = 10, alpha = 0.5, linewidth = 1, label = r'$L=64$')
ax[0].scatter(p1_array, avg_ratio_infected_p1_03_03_L96, color = 'black', s = 10, alpha = 0.5, linewidth = 1, label = r'$L=96$')
ax[0].plot(p1_array, avg_ratio_infected_p1_03_03_L32, color = 'xkcd:red pink', alpha = 0.5, linewidth = 1, linestyle = '--')
ax[0].plot(p1_array, avg_ratio_infected_p1_03_03_L64, color = 'blue', alpha = 0.5, linewidth = 1, linestyle = '--')
ax[0].plot(p1_array, avg_ratio_infected_p1_03_03_L96, color = 'black', alpha = 0.5, linewidth = 1, linestyle = '--')
...
ax[1].scatter(p1_array, avg_ratio_infected_p1_06_03_L64, color = 'blue', s = 10, alpha = 0.5, linewidth = 1, label = r'$L=64$')
ax[1].scatter(p1_array, avg_ratio_infected_p1_06_03_L96, color = 'black', s = 10, alpha = 0.5, linewidth = 1, label = r'$L=96$')
ax[1].plot(p1_array, avg_ratio_infected_p1_06_03_L32, color = 'xkcd:red pink', alpha = 0.5, linewidth = 1, linestyle = '--')
ax[1].plot(p1_array, avg_ratio_infected_p1_06_03_L64, color = 'blue', alpha = 0.5, linewidth = 1, linestyle = '--')
ax[1].plot(p1_array, avg_ratio_infected_p1_06_03_L96, color = 'black', alpha = 0.5, linewidth = 1, linestyle = '--')
...
ax[2].scatter(p1_array, avg_ratio_infected_p1_03_06_L64, color = 'blue', s = 10, alpha = 0.5, linewidth = 1, linestyle = '--', label = r'$L=64$')
ax[2].scatter(p1_array, avg_ratio_infected_p1_03_06_L96, color = 'black', s = 10, alpha = 0.5, linewidth = 1, linestyle = '--', label = r'$L=96$')
ax[2].plot(p1_array, avg_ratio_infected_p1_03_06_L32, color = 'xkcd:red pink', alpha = 0.5, linewidth = 1, linestyle = '--')
ax[2].plot(p1_array, avg_ratio_infected_p1_03_06_L64, color = 'blue', alpha = 0.5, linewidth = 1, linestyle = '--')
ax[2].plot(p1_array, avg_ratio_infected_p1_03_06_L96, color = 'black', alpha = 0.5, linewidth = 1, linestyle = '--')
...
ax[0].grid(which='minor', color = '#999999', alpha = 0.2, linestyle = '-')
ax[0].minorticks_on()
ax[0].scatter(p1_array, avg_ratio_infected_p1_03_03_L96, color = 'xkcd:red pink', s = 10, alpha = 0.5, linewidth = 1, label = r'$p_2=0.3$, $p_3=0.3$')
ax[0].scatter(p1_array, avg_ratio_infected_p1_06_03_L96, color = 'blue', s = 10, alpha = 0.5, linewidth = 1, label = r'$p_2=0.6$, $p_3=0.3$')
ax[0].scatter(p1_array, avg_ratio_infected_p1_03_06_L96, color = 'black', s = 10, alpha = 0.5, linewidth = 1, label = r'$p_2=0.3$, $p_3=0.6$')
ax[0].plot(p1_array, avg_ratio_infected_p1_03_03_L96, color = 'xkcd:red pink', alpha = 0.5, linewidth = 1, linestyle = '--')
ax[0].plot(p1_array, avg_ratio_infected_p1_06_03_L96, color = 'blue', alpha = 0.5, linewidth = 1, linestyle = '--')
ax[0].plot(p1_array, avg_ratio_infected_p1_03_06_L96, color = 'black', alpha = 0.5, linewidth = 1, linestyle = '--')
...
ax[1].grid(which='minor', color = '#999999', alpha = 0.2, linestyle = '-')
ax[1].minorticks_on()
ax[1].scatter(p1_array, avg_ratio_infected_p1_03_03_L96, color = 'xkcd:red pink', s = 10, alpha = 0.5, linewidth = 1, label = r'$p_2=0.3$, $p_3=0.3$')
ax[1].scatter(p1_array, avg_ratio_infected_p1_06_03_L96, color = 'blue', s = 10, alpha = 0.5, linewidth = 1, label = r'$p_2=0.6$, $p_3=0.3$')
ax[1].scatter(p1_array, avg_ratio_infected_p1_03_06_L96, color = 'black', s = 10, alpha = 0.5, linewidth = 1, label = r'$p_2=0.3$, $p_3=0.6$')
ax[1].plot(p1_array, avg_ratio_infected_p1_03_03_L96, color = 'xkcd:red pink', alpha = 0.5, linewidth = 1, linestyle = '--')
ax[1].plot(p1_array, avg_ratio_infected_p1_06_03_L96, color = 'blue', alpha = 0.5, linewidth = 1, linestyle = '--')
ax[1].plot(p1_array, avg_ratio_infected_p1_03_06_L96, color = 'black', alpha = 0.5, linewidth = 1, linestyle = '--')
...
ax.scatter(p4_array, avg_ratio_infected_p4_L64, color = 'blue', s = 10, alpha = 0.5, linewidth = 1, label = r'$L=64$')
ax.scatter(p4_array, avg_ratio_infected_p4_L96, color = 'black', s = 10, alpha = 0.5, linewidth = 1, label = r'$L=96$')
ax.plot(p4_array, avg_ratio_infected_p4_L32, color = 'xkcd:red pink', alpha = 0.5, linewidth = 1, linestyle = '--')
ax.plot(p4_array, avg_ratio_infected_p4_L64, color = 'blue', alpha = 0.5, linewidth = 1, linestyle = '--')
ax.plot(p4_array, avg_ratio_infected_p4_L96, color = 'black', alpha = 0.5, linewidth = 1, linestyle = '--')
