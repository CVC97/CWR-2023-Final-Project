...
ax[0].minorticks_on()
ax[0].scatter(p1_array, avg_ratio_infected_p1_03_03_L16, color = 'xkcd:lightblue', s = 10, alpha = 0.75, linewidth = 1, label = r'$L=16$')
...
ax[0].plot(p1_array, avg_ratio_infected_p1_03_03_L16, color = 'xkcd:lightblue', alpha = 0.75, linewidth = 1, linestyle = '--')
...
ax[1].minorticks_on()
ax[1].scatter(p1_array, avg_ratio_infected_p1_06_03_L16, color = 'xkcd:lightblue', s = 10, alpha = 0.75, linewidth = 1, label = r'$L=16$')
...
ax[1].scatter(p1_array, avg_ratio_infected_p1_06_03_L128, color = 'black', s = 10, alpha = 0.5, linewidth = 1, label = r'$L=96$')
ax[1].plot(p1_array, avg_ratio_infected_p1_06_03_L16, color = 'xkcd:lightblue', alpha = 0.75, linewidth = 1, linestyle = '--')
...
ax[2].minorticks_on()
ax[2].scatter(p1_array, avg_ratio_infected_p1_03_06_L16, color = 'xkcd:lightblue', s = 10, alpha = 0.75, linewidth = 1, linestyle = '--', label = r'$L=16$')
...
ax[2].scatter(p1_array, avg_ratio_infected_p1_03_06_L128, color = 'black', s = 10, alpha = 0.5, linewidth = 1, linestyle = '--', label = r'$L=96$')
ax[2].plot(p1_array, avg_ratio_infected_p1_03_06_L16, color = 'xkcd:lightblue', alpha = 0.75, linewidth = 1, linestyle = '--')
...
ax.minorticks_on()
ax.scatter(p4_array, avg_ratio_infected_p4_L16, color = 'xkcd:lightblue', s = 10, alpha = 0.75, linewidth = 1, label = r'$L=16$')
...
ax.plot(p4_array, avg_ratio_infected_p4_L16, color = 'xkcd:lightblue', alpha = 0.75, linewidth = 1, linestyle = '--')
